...
export default function App() {
  ...
  async function handlePhoto(e) {
    ...
    if (!file) return;
    setForm(f => ({ ...f, photo: null })); // clear while compressing
        ...
        <div style={{ padding: "36px 24px 16px", ...div }}>
          ...
          {entries.length > 0 && (
            <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
              <button onClick={() => handlePrint(entries)} style={{ flex: 1, background: "#1C1814", border: "1px solid #2A2520", color: "#7A7470", borderRadius: 9, padding: "9px", fontSize: 12, cursor: "pointer", fontFamily: "'DM Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
